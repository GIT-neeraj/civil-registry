<%@ Page Language="C#" AutoEventWireup="true" CodeFile="forum.aspx.cs" Inherits="forum" MasterPageFile="~/masterhome.master" %>
    ...
    <%
        ...
        if (pages > 0)
        {
            ...
            for (int i = 1; i <= pages; i++)
            {
                ...
                {
                    Response.Write("<a href=forum.aspx?page=" + i + ">" + i + "</a>&nbsp");
                }
            }
    ...
    %>
        ...
        <table style="width: 687px; margin-top:15px; border:#666666; border:thin; border-style:double">
            <tr >
                <td style="height: 21px; text-align:right " colspan="2">
                    <asp:HyperLink ID="HyperLink1" runat="server" Font-Bold="True" Font-Size="Medium"
                        ForeColor="#C000C0" NavigateUrl="~/postthread.aspx">Post thread</asp:HyperLink></td>
            </tr>
            <%  
                if (pages > 0)
                {
                    ...
                    <table style="width: 203px">
                        ...
                        <tr>
                            <td style="height: 21px">
                                <a href="postreplay.aspx?id=<%=postid %>" style="border:none">
            ...
            <tr>
                ...
                <a href="viewcomments.aspx?id=<%=postid %>" style="border:none; float:right">
