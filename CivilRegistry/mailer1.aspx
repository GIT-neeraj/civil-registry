<%@ Page Language="C#" AutoEventWireup="true" CodeFile="mailer1.aspx.cs" Inherits="mailer" MasterPageFile="~/AdminMaster.master" %>
<asp:Content ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table style="width: 688px; height: 145px">
        <tr>
            <td style="width: 56px">
            </td>
            <td style="width: 76px">
        ...
        <tr>
            ...
            <td style="width: 76px">
                <asp:ImageButton ID="btnSendmail" runat="server" ImageUrl="~/images/sendmail.png" OnClick="btnSendmail_Click" /></td>
            <td style="width: 100px">
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td style="width: 76px">
                <asp:Label ID="lblmsg" runat="server" Font-Bold="True" ForeColor="#FF8080" Width="391px"></asp:Label></td>
            <td style="width: 100px">
            </td>
        </tr>
    </table>
