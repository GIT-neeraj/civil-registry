<%@ Page Language="C#" AutoEventWireup="true" CodeFile="postthread.aspx.cs" Inherits="postthread" MasterPageFile="~/AdminMaster.master" %>
...
<div >
    <table style="width: 689px">
        <tr style="background:#CCCCCC; font-size:15px; font-weight:bold">
            ...
            <a href= "postthreadadmin.aspx" style="font-size:14px; font-weight:bold; color:#CC3399; text-decoration:none;" >
                New post</a></td>
            </tr>
            </table>
                </td>
