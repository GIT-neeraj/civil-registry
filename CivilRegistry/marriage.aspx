...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table style="width: 655px">
        ...
        <tr>
            <td colspan="3" style="height: 479px">
                ...
                <asp:TextBox ID="txtperwife" runat="server" TextMode="MultiLine" Width="143px"></asp:TextBox></td>
                    ...
                    <tr>
                        <td style="width: 100px">
                <asp:Label ID="Label10" runat="server" Text="Voter I-Card No." Font-Bold="True" Font-Names="Times New Roman" Font-Size="Medium" Width="158px"></asp:Label></td>
                        <td style="width: 100px">
        ...
        <tr>
            <td style="width: 100px">
                <asp:Label ID="Label15" runat="server" Text="Any Relationship between parties before Marriage"
                    Width="295px" Font-Bold="True" Font-Names="Times New Roman" Font-Size="Medium"></asp:Label></td>
            <td style="width: 100px">
                <asp:TextBox ID="txtrel" runat="server"></asp:TextBox></td>
            <td style="width: 100px">
                &nbsp;</td>
        </tr>
        <tr>
