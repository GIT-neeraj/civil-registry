<%@ Page Language="C#" MasterPageFile="~/AdminMaster.master" AutoEventWireup="true" CodeFile="Admindivhus.aspx.cs" Inherits="Default2" Title="Untitled Page" %>
...
<div style="overflow:scroll; width:530px; height: 282px;">
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="White"
        ...
        <Columns>
            ...
            <asp:BoundField DataField="addressforservicce" HeaderText="Address for service"
                SortExpression="addressforservicce" >
                <HeaderStyle Wrap="False" />
            </asp:BoundField>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:civilRegDB %>"
        ProviderName="<%$ ConnectionStrings:civilRegDB.ProviderName %>" SelectCommand="SELECT [SNo], [familyname], [fullname], [dob], [country], [occupation], [resaddress], [addressforservicce], [lawername], [lawfirmname], [lawyerscode], [phno], [fax], [email] FROM [divorcehusband]">
    </asp:SqlDataSource>
    </div>
</asp:Content>
