<%@ Page Language="C#" AutoEventWireup="true" CodeFile="postreplay.aspx.cs" Inherits="postreplay" MasterPageFile="~/masterhome.master"%>
    ...
    <table style="width: 683px; height: 42px">
        ...
        <tr>
            ...
            <%
                ...
                {
            %>
                <a href="mailer.aspx?id=<%=mailid %>" style ="font-weight:bold; font-size:16px; text-decoration:none; color:AppWorkspace" >Send mail</a>
            <%} %>        
            </td>
